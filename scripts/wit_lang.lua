...
if LANG == "zh" then
	...
	TXT.CFG_DETAIL_LCLICK_LABEL = "合成菜单左键默认页签"
	TXT.CFG_DETAIL_LCLICK_HOVER = "在合成菜单详情面板中左键产物图标时，默认跳转到该页签"
	TXT.CFG_DETAIL_RCLICK_LABEL = "合成菜单右键默认页签"
	TXT.CFG_DETAIL_RCLICK_HOVER = "在合成菜单详情面板中右键图标时，默认跳转到该页签"
	TXT.CFG_POPUP_LCLICK_LABEL = "弹窗/来源键默认页签"
	TXT.CFG_POPUP_LCLICK_HOVER = "在弹窗槽位中点选图标或按来源键(R)时，默认跳转到该页签"
	TXT.CFG_POPUP_RCLICK_LABEL = "弹窗/用途键默认页签"
	TXT.CFG_POPUP_RCLICK_HOVER = "在弹窗槽位中右键图标或按用途键(U)时，默认跳转到该页签"
	TXT.CFG_GRID_AUTO_LABEL = "合成菜单网格自动查询"
	TXT.CFG_GRID_AUTO_HOVER = "在合成菜单网格中点击配方时，自动打开 WIT 查询弹窗"
	TXT.TAB_DISABLED = "关闭"
	TXT.CFG_ON = "开"
	TXT.CFG_OFF = "关"
	...
	TXT.CFG_DETAIL_LCLICK_LABEL = "Crafting Menu Left-Click Default Tab"
	TXT.CFG_DETAIL_LCLICK_HOVER = "When left-clicking an icon in the crafting menu detail panel, defaults to this tab"
	TXT.CFG_DETAIL_RCLICK_LABEL = "Crafting Menu Right-Click Default Tab"
	TXT.CFG_DETAIL_RCLICK_HOVER = "When right-clicking an icon in the crafting menu detail panel, defaults to this tab"
	TXT.CFG_POPUP_LCLICK_LABEL = "Popup / Source Key Default Tab"
	TXT.CFG_POPUP_LCLICK_HOVER = "When left-clicking a slot in the popup or pressing the Source key (R), defaults to this tab"
	TXT.CFG_POPUP_RCLICK_LABEL = "Popup / Usage Key Default Tab"
	TXT.CFG_POPUP_RCLICK_HOVER = "When right-clicking a slot in the popup or pressing the Usage key (U), defaults to this tab"
	TXT.CFG_GRID_AUTO_LABEL = "Auto-Open on Recipe Grid Click"
	TXT.CFG_GRID_AUTO_HOVER = "Automatically opens the WIT popup when clicking a recipe in the crafting grid"
	TXT.TAB_DISABLED = "Disabled"
	TXT.CFG_ON = "On"
	TXT.CFG_OFF = "Off"
end
