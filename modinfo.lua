...
configuration_options =
{
    ...
    },
    {
        ...
        options =
        {
            ...
            {description = "制作来源", data = "CRAFT_FROM"},
            {description = "烹饪来源", data = "COOK_FROM"},
